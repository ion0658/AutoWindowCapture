...
namespace winrt::WindowGraphicCaptureNative::implementation
{
    struct WindowCapture : WindowCaptureT<WindowCapture>
    {
        ...
        winrt::event_token FrameArrived(winrt::WindowGraphicCaptureNative::FrameArrivedHandler const& handler);
        void FrameArrived(winrt::event_token const& token) noexcept;
        winrt::event_token CaptureStopped(winrt::WindowGraphicCaptureNative::CaptureStoppedHandler const& handler);
...
{
    struct WindowCapture : WindowCaptureT<WindowCapture, implementation::WindowCapture>
    {
    };
}
