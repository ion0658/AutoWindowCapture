...
{
    winrt::event_token WindowCapture::FrameArrived(winrt::WindowGraphicCaptureNative::FrameArrivedHandler const& handler)
    {
    ...
    winrt::event_token WindowCapture::CaptureStopped(winrt::WindowGraphicCaptureNative::CaptureStoppedHandler const& handler)
    {
        throw hresult_not_implemented();
    }
